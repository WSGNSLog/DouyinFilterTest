...
@property(nonatomic,strong) MyGLKView *glkImageView;
...
- (MyGLKView *)glkImageView{
    if (!_glkImageView) {
        _glkImageView = [[MyGLKView alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(self.view.frame)/2 - CGRectGetWidth(self.view.frame)/2, CGRectGetWidth(self.view.frame), CGRectGetWidth(self.view.frame))];
